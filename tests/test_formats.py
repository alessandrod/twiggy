...
class ConversionsTestCase(unittest.TestCase):
    ...
    def test_line_conversion(self):
        d = self.fields.copy()
        assert formats.line_format.conversion.convert(d) == '2010-10-28T02:15:57.000301:INFO:mylog:pants=42'

        del d['pants']
        assert formats.line_format.conversion.convert(d) == '2010-10-28T02:15:57.000301:INFO:mylog'

        del d['name']
        assert formats.line_format.conversion.convert(d) == '2010-10-28T02:15:57.000301:INFO'
...
class FormatTestCase(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        assert fmt(msg) == '2010-10-28T02:15:57.000301:INFO:mylog:pants=42|I wear pants\n'
    ...
    def test_suppress_newline_true(self):
        ...
        assert s == '2010-10-28T02:15:57.000301:INFO:mylog:pants=42|I wear pants\\nDo you?\n', repr(s)
    ...
    def test_trace(self):
        ...
        assert l[0] == '2010-10-28T02:15:57.000301:INFO:mylog:pants=42|I wear pants'
